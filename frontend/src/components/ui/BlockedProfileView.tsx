...
export default function BlockedProfileView() {
  return (
    <div className="flex-1 flex flex-col items-center justify-center p-12 md:p-24 text-center gap-8 bg-surface/10 relative overflow-hidden">
        ...
        <hgroup className="relative z-10 flex flex-col gap-3">
            <h3 className="text-4xl md:text-5xl font-black text-white tracking-widest uppercase italic font-druk">Silence Absolu</h3>
