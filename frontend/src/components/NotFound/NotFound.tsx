...
export default function NotFound() {
  ...
  return (
    <section className="bg-background flex flex-col items-center justify-center gap-4 w-full min-h-screen p-4">
      <h1 className="text-[6rem] font-druk text-primary animate-in zoom-in duration-500">404</h1>
      <h2 className="text-[1.5rem] font-sf-pro font-bold text-text-primary">Oops! Page not found.</h2>
